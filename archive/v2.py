...
Now with JSON config file support for easy customization
"""
...
class G75Controller:
    def __init__(self, config_file="crew_motorfest_config.json", deadzone_min=2, deadzone_max=36, polling_interval_ms=5):
        ...
        # Button states (for digital buttons)
        self.button_states = {}
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="DrunkDeer to Xbox Controller Emulator with Config File Support"
    )
